...
1. **Include all diagrams** in your report's "System Design" chapter
2. **Label each diagram** clearly (Figure 1, Figure 2, etc.)
3. **Add captions** explaining what each diagram shows
4. **Use consistent colors**:
   - Green for success paths
   - Red for error paths
   - Blue for data flow
   - Yellow for decision points
5. **Keep it simple** — don't overcomplicate diagrams
6. **Test with your guide** — show them a draft first
...
├── 3.1 System Architecture (Diagram 1)
├── 3.2 Application Flow (Diagram 2)
├── 3.3 Retry Mechanism (Diagram 3)
├── 3.4 Duplicate Prevention (Diagram 4)
├── 3.5 Data Flow Diagram (Diagram 5)
├── 3.6 Class Structure (Diagram 6)
└── 3.7 Deployment Architecture (Diagram 7)
```
